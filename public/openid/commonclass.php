...
class TC_OID_BASE{
  ...
  private function createTCaxs(){
    ...
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.chc.edu.tw/schema/1.0/schooldistrict',1,1, 'schooldistrict');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.chc.edu.tw/schema/1.0/schoolname',1,1, 'schoolname');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.chc.edu.tw/schema/1.0/schooltitle',1,1, 'schooltitle');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.chc.edu.tw/schema/1.0/schooltype',1,1, 'schooltype');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.chc.edu.tw/schema/1.0/subtitle',1,1, 'subtitle');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.edu.tw/axschema/person/guid',1,1,'guid');
    $attribute[]=Auth_OpenID_AX_AttrInfo::make('http://openid.edu.tw/axschema/school/titleStr',1,1,'titleStr');
    return $attribute;
  }
